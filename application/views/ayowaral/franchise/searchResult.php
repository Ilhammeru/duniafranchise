...
<div class="row" style="padding: 0 1em;">
    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2" style="margin-top: 0.8em; padding:0;">
        ...
        <div>
            <?php for ($pr = 0; $pr < count($premImg); $pr++) : ?>
                <img onclick="navigate(<?= $premId[$pr]; ?>, 'ayowaralaba/franchise/detail_brand/<?= $premId[$pr]; ?>')" class="img-left lazyload" data-src="<?= $premImg[$pr]; ?>" alt="">
            <?php endfor; ?>
        </div>
        ...
        <div>
            <?php for ($lf = 0; $lf < count($leftImg); $lf++) : ?>
                <img onclick="navigate(<?= $leftId[$lf]; ?>, 'ayowaralaba/franchise/detail_brand/<?= $leftId[$lf]; ?>')" class="img-left lazyload" data-src="<?= $leftImg[$lf]; ?>" alt="">
            <?php endfor; ?>
        </div>
    </div>
    ...
    <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10" style="margin-top: 0.8em; padding: 0 0.5em;">
        ...
        <!-- list franchise -->
        <div class="target-franchise row" style="padding: 0 0.8em;">

            <?php
            for ($x = 0; $x < count($result['fId']); $x++) {
                echo '<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 col-franchise-menu">';
                echo '<div class="card card-franchise">';
                echo '<div class="card-body">';
                echo '<div class="card-img">';
                echo '<img class="lazyload" data-src="' . $result['fImg'][$x] . '" alt="..." style="width: 100%; height: auto;">';
                echo '</div>';
                echo '<p class="franchise-name" onclick="detail_brand(' . $result['fId'][$x] . ')">' . $result['fName'][$x] . '</p>';
                echo '<p class="franchise-content">' . $result['fText'][$x] . '</p>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
            }
        ...
        <div class="center-banner-page-news">
            <?php for ($i = 0; $i < count($centerImg); $i++) : ?>
                <img onclick="navigate(<?= $centerId[$i]; ?>, 'ayowaralaba/franchise/detail_brand/<?= $centerId[$i]; ?>')" class="lazyload" data-src="<?= $centerImg[$i]; ?>" alt="" style="width:100%; height: auto; margin: 0.8em 0; ">
            <?php endfor; ?>
        </div>
        <!-- end center banner -->
