<!DOCTYPE html>
    ...
    <script type="text/javascript">
        ...
        var titleExport = 'Franchise Report';
        var columnExport = [ ':visible:not(.not-export-col)' ];

        $(document).ready( function () {

            $('#tableFranchise thead tr').clone(true).appendTo('#tableFranchise thead');

            $('#tableFranchise thead tr:eq(1) th').each( function (i) {
            ...
            var tableFranchise  = $('#tableFranchise').DataTable({
                ...
                // Data
                ajax: {
                    url: "<?=site_url('franchise/get_data_franchise');?>",
                    type: "POST"
                },
                processing: true,
                serverSide: true,
                ...
                buttons: [ 
                            ...
                            },
                            {
                                ...
                                action: function ( e, dt, node, config ) {
                                    location.href = "<?=site_url('franchise/new_franchise');?>"                
                                }
                            },
                        ],
                dom: 'Bfrtip',
            ...
            tableFranchise.buttons().container().appendTo('#example_wrapper .col-sm-6:eq(0)');

            $('#tableFranchise tbody').on('click', '.franchise-delete', function () {

                var code = $(this).attr('code');

                $('#deleteFranchiseId').val(code);
            ...
            $('body').on('shown.bs.modal', '#modalConfirmDelete', function () {
                ...
                var id = $('#deleteFranchiseId').val();

                $('#buttonConfirmDelete').click(function () {

                    location.href = '<?=site_url('franchise/delete/franchise_id');?>/' + id;
            ...
            $("body").on("shown.bs.modal", ".dtr-bs-modal", function () {
                ...
                $('.dtr-details').on('click', '.franchise-delete', function () {
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 table-responsive">
            ...
            <table class="table table-stripted table-bordered" id="tableFranchise" style="width: 100%">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="deleteFranchiseId">
...
<!--
    ...
    Location: ./application/views/webadmin/content/franchise/index.php
-->
