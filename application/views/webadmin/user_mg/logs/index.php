	...
	<script type="text/javascript">
        ...
        $(document).ready( function () {
            ...
            $('#tableLogs thead tr:eq(1) th').each( function (i) {
                ...
                switch (i) {
                    ...
                    case 3 :
                        ...
                        $(this).html('<?php echo $filterAccess;?>');
        	...
        	var tableLogs  = $('#tableLogs').DataTable({
                ...
                // Data
                ajax: {
                    url: "<?=site_url('logs/get_data_log_activity');?>",
                    type: "POST"
                },
                processing: true,
                serverSide: true,
...
<!--
	...
	Location: ./application/views/webadmin/user_mg/logs/index.php
-->