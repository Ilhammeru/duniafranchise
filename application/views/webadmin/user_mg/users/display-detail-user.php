<!DOCTYPE html>
	...
	<div class="modal fade" id="modalDetailUser">
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header bg-aqua">
                    ...
                    <h4 class="modal-title"><i class="fa fa-list-alt"></i> User Detail</h4>
                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td colspan="2" style="text-align:center">
                                            ...
                                            if ( empty($users['images'])) {
                                                ...
                                                echo '<img src="' . base_url() . 'assets/img/no-image.jpg" class="img-thumbnail user-image" alt="User Image">';                                    

                                            } else {
                                                        
                                                echo '<img src="' . base_url() . $users['images'] . '" class="img-thumbnail user-image" alt="User Image">';
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo date_format(date_create($users['updated_time']), 'd M Y H:i');?></td>
                                    </tr>
...
<!--
    This is a content
    End of file display-detail-user.php
    Location: ./application/views/webadmin/user_mg/users/display-detail-user.php
-->